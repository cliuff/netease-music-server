...
public interface PlaylistMapper extends BaseMapper<Playlist> {
    ...
    @Select("SELECT playlist_id, playlist_name,cover,view_counts FROM `playlist` order by view_counts desc limit 0,10")
    ...
    @Select("SELECT * from playlist where playlist_id=#{plalylistId}")
    public Playlist selectInfo(String plalylistId);
}
